...
// Note: the Chebyshev *expansion* classes (ChebyshevExpansionTau /
// ChebyshevExpansionMatsubara) now live in ../expansion.hpp, alongside the grid
// expansions, behind the unified TensorExpansion interface. This header keeps
// only the numerical ChebyshevBasisImpl.
